...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex-col justify-center items-center w-full max-xl:padding-x pt-28">
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innavation for your activa life.</p>
